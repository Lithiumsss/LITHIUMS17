...
LINKS = [
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282592Pvsc4e0rf9dh4h8fqxus&balance=0&currency=USD&userid=14234138&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282596Pnq6ppit56024lplsnp0&balance=0&currency=USD&userid=14234143&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282604Pzeaao2ryu2b9gc6vnyd&balance=0&currency=USD&userid=14234151&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282607P9s1gx0dcuzk8daqoj6v&balance=0&currency=USD&userid=14234154&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282752P8i84fpslw4wmssohcv3&balance=0&currency=USD&userid=14234302&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282757Ppagfk2ylsxx2sy0ye18&balance=0&currency=USD&userid=14234307&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14282768P8z6nmn08qkwd7nc2sg8&balance=0&currency=USD&userid=14234318&isMobile=false"
]
...
def abrir_y_verificar_tags_todos(dr):
    print("⏳ [LITHIUMS17 - HEADLESS] Abriendo y preparando todos los chats en segundo plano...")
    handles = []
...
def run():
    ...
    try:
        ...
        print(f"\n🚀 [LITHIUMS17 ACTIONS] INICIANDO RACHAS INTELIGENTES ({num_tags} chats activos)...")
            ...
            for idx in range(num_tags):
                ...
                if ahora >= proximo_disparo_por_tag[idx]:
                    ...
                    if disparar_con_protocolo_seguro(dr, handles[idx], idx, msg):
                        ...
                        print(f"    ⚡ [LITHIUMS17] Chat #{idx+1} enviado | Total ciclo: {total_disparos_global}/{MAX_DISPAROS_CICLO}")
        ...
        print(f"\n🎯 [LITHIUMS17] META DE {MAX_DISPAROS_CICLO} ALCANZADA.")
        
    except Exception as e:
        print(f"⚠️ [LITHIUMS17] Error en ejecución: {e}")
    finally:
        try: dr.quit()
        except: pass
        ...
        historial_enviados.clear()
        gc.collect()
        print("🔄 [LITHIUMS17] Ciclo finalizado correctamente en GitHub Actions.\n")
